...
import { getCalendarDays, formatDate, getShiftTimeSlots } from "@/lib/utils";
...
import { TimeSlotMarker } from "./TimeSlotMarker";
...
export function MonthlyCalendar() {
  ...
  const timeSlots = getShiftTimeSlots(shifts);
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden border border-gray-200">
          <div className="grid grid-cols-[80px_repeat(7,1fr)] border-b border-gray-200">
            <div className="py-2 text-center font-semibold text-sm border-r border-gray-200 bg-gray-50">Orario</div>
          ...
          <div className="grid grid-cols-[80px_repeat(7,1fr)]">
            <div className="flex flex-col">
              {timeSlots.map((slot, index) => (
                <TimeSlotMarker key={index} startTime={slot} />
              ))}
            </div>
